# pokedex numbers for all these are wrong?
# ParentChild=[
...
FindSomeone=[
"{target} passed out from the heat!",
"{target} may be endangered!",
"{target} is still missing.",
"{target} hasn't been heard from!",
"{target} can't swim!",
"{target} hasn't come back!",
"{target} might be unable to return.",
"{target} may be facing danger!",
"{target} appears to be injured!",
"{target} went missing this morning!",
"{target} is too scared to move!",
"{target} may be confused!",
"{target} appears to be freezing!",
"Trouble may have found {target}!",
"{target} was paralyzed!",
"{target}'s whereabouts are unknown!",
"I'm worried about {target}!",
"{target} has been cornered!",
"{target}'s been gone a long time!",
"{target} is about to faint!",
"{target} may have fainted already!",
"It appears as if {target} can't escape!",
"{target} was attacked by assailants!",
"{target} hasn't reemerged!",
"{target} appears to be helpless!",
"{target} is stuck in a cave!",
"{target} appears to be trapped!",
"Something happened to {target}!",
"{target} was attacked, maybe!",
"{target} is running out of time!",
"I got separated from {target}.",
"Hurry, bring back {target}.",
"{target} is too hungry to move!",
"{target} is fighting all alone!",
"I'm worried for {target}'s safety!",
"{target} may have had an accident!",
"{target} appears to be lost!",
"{target} appears to be stuck!",
"{target} is lost!",
"{target} went the wrong way!",
"{target}'s been missing three days!",
"{target} can't walk anymore!",
"I can't contact {target}!",
"I lost contact with {target}!",
"{target} fell into a trap!"
]
FindSomeoneP2=[
"Please! Someone help!",
"Please! I need help!",
...
Escort=[
"{target} is waiting for me!",
"We promised to meet in the dungeon!",
"I want to meet with {target}.",
"I'm worried about {target}...",
"I can't go by myself...",
"I can't go on my own power...",
"I'm too weak. It's not possible.",
"{target} is waiting in the dungeon.",
"{target} has been waiting forever...",
"Hurry, {target} is in trouble...",
"I want to help {target}!",
"{target} hasn't returned!",
"{target} may have fainted inside...",
"I'm sick with worry...",
"We haven't seen each other in a long time.",
"I have to go!",
"We have to meet--whatever it takes!",
"I don't care how--we must meet!",
"I want to apologize to {target}.",
"I'm close friends with {target}!"
]
EscortP2=[
"Please take me to see {target}!",
"Please take me there with you!",
"Please escort me there!",
"Someone, please escort me!"
]
FindItem=[
"Having one {item} is reassuring.",
"{item}--it's convenient to have.",
"{item} wanted after long search.",
"{item} wanted for exploration.",
"{item}--I'd love to utilize one!",
"{item}--I can't leave without it.",
"{item} wanted as a charm.",
"{item}! Seeking in quantity!",
"Help this {item} collector!",
"I can't find one more {item}.",
"Hard-to-find {item} sought.",
"{item}--I get scared without it!",
"I can't sleep without it: {item}.",
"{item} makes me strong.",
"{item}--it's my mom's favorite.",
"{item}'s texture is comforting.",
"{item} wanted to test effects.",
"{item} wanted for nostalgia.",
"I lost my {item}.",
"Wanted: my own {item}.",
"The item {item} is the in thing!",
"Is it true about the {item}?"
]
FindItemP2=[
...
# ]
# Mankey="Please punish bad Mankey's gang."
# Smeargle="I didn't want to become a grown-up, so I <!--break-->fled, but now I've lost my way! Help!"
# Medicham="This is Medicham. Rescue me, please! <!--break-->The reward is a secret~&#x266A; "
# EvoTitle="With the item %s, I can <!--break-->evolve! I'm yearning to evolve! Help!"
# FoodTitle="The %s! What I love to eat <!--break-->and can't live without! Please get one!"
# MankeyTitle="Punish bad Mankey!"
# SmeargleTitle="Smeargle's desperate plea!"
# MedichamTitle="Medicham: Help me!"
# ParentTitle="Save my child!"
# LoverTitle="Escort me to my love!"
DeliverTitle="Deliver one {item}."
DeliverTitle2="One {item} wanted!"
RescueTitle=[
"Help!",
"I can't get out!",
"I'm in trouble...",
